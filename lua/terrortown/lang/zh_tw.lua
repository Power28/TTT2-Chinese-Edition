...
-- Karma
L.karma_dmg_full = "你的業障值為 {amount}，因此本回合你擁有造成百分之百傷害的待遇！"
L.karma_dmg_other = "你的業障值為 {amount}，因此本回合你造成的傷害將減少 {num}%"
...
L.disg_help1 = "偽裝開啟後，別人瞄準你時，將不會看見你的名字，生命以及業障值。除此之外，你也能躲避探長的雷達。"
...
L.label_minimal_targetid = "簡易目標高亮（沒有業障值，提示等）"
...
L.help_karma_ratio = "用於計算如果雙方在同一個團隊中，受害者的業障值被減去多少的傷害比例。如果發生擊殺友軍事件，會有進一步的懲罰。"
L.help_karma_traitordmg_ratio = "如果雙方在不同的隊伍中，用來計算受害者的業障值被減去多少的傷害比率。如果發生擊殺事件，會有進一步的獎勵。"
L.help_karma_bonus = "在一個回合中也有兩種不同的被動方式來獲得業障值。首先，一個回合的回復會應用於每個玩家。然後，如果沒有傷害隊友或擊殺，會有一個二次回復的獎勵。"
L.help_karma_clean_half = [[
當玩家的業障值高於起始水平時（意味著業障值最大值已被配置為高於該水平），他們所有的業障值增加將根據其業障值高於起始水平的程度而減少。因此，它越高，增加的速度就越慢。

這種減少是以指數衰減的曲線進行的：最初速度很快，隨著增量的變小，速度也會變慢。這個控製臺指令設定了獎金減半的時間點（即半衰期）。在默認值為0.25的情況下，如果業障值的起始值為1000，最大值為1500，而玩家有1125((1500-1000)*0.25=125)業障值，那麽他的無誤殺輪獎勵將是30/2=15。因此，為了使值下降得更快，你應該把該設置得更低，為了使它下降得更慢，你應該把它增加到1。]]
...
L.search_title_dmg_crush = "擠壓傷害 ({amount} 生命值)"
L.search_title_dmg_bullet = "槍彈傷害 ({amount} 生命值)"
L.search_title_dmg_fall = "跌落傷害 ({amount} 生命值)"
L.search_title_dmg_boom = "爆炸傷害 ({amount} 生命值)"
L.search_title_dmg_club = "鈍器傷害 ({amount} 生命值)"
L.search_title_dmg_drown = "溺水傷害 ({amount} 生命值)"
L.search_title_dmg_stab = "刺傷傷害 ({amount} 生命值)"
L.search_title_dmg_burn = "燒傷傷害 ({amount} 生命值)"
L.search_title_dmg_teleport = "傳送傷害 ({amount} 生命值)"
L.search_title_dmg_car = "車禍 ({amount} 生命值)"
L.search_title_dmg_other = "未知傷害 ({amount} 生命值)"
L.search_title_time = "死亡時間"
L.search_title_dna = "DNA樣本衰變"
L.search_title_kills = "受害者名單"
L.search_title_eyes = "眼中的倒影"
L.search_title_floor = "犯罪現場的地板"
L.search_title_credits = "{credits} 裝備點數"
L.search_title_water = "水位 {level}"
L.search_title_policingrole_report_confirm = "確認死亡"
...
L.label_keyhelper_chat_global = "全域對話"
L.label_keyhelper_chat_team = "隊伍對話"
L.label_keyhelper_show_all = "顯示所有"
L.label_keyhelper_disguiser = "開啟偽裝器"
L.label_keyhelper_save_exit = "儲存後退出"
